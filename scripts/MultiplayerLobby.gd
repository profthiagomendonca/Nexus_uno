...
func _on_start_game_pressed():
	...
	print("Host: Creating initial game state")
	var game_state = create_initial_game_state()
	print("Host: Initial game state created")
	
	# Atualizar no Firebase
	var success = await FirebaseManager.update_room_state(game_state)
	print("Host: update_room_state success=", success)
	if success:
		_on_game_started()
	else:
...
func _on_game_started():
	print("Host: _on_game_started triggered=", game_started_triggered)
